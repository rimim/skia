...
SK_C_API size_t sk_runtimeeffect_get_input_size(const sk_runtimeeffect_t* effect);
SK_C_API size_t sk_runtimeeffect_get_inputs_count(const sk_runtimeeffect_t* effect);
SK_C_API void sk_runtimeeffect_get_input_name(const sk_runtimeeffect_t* effect, int index, sk_string_t* name);
SK_C_API const sk_runtimeeffect_variable_t* sk_runtimeeffect_get_input_from_index(const sk_runtimeeffect_t* effect, int index);
SK_C_API const sk_runtimeeffect_variable_t* sk_runtimeeffect_get_input_from_name(const sk_runtimeeffect_t* effect, const char* name, size_t len);
...
SK_C_API size_t sk_runtimeeffect_variable_get_offset(const sk_runtimeeffect_variable_t* variable);
SK_C_API size_t sk_runtimeeffect_variable_get_size_in_bytes(const sk_runtimeeffect_variable_t* variable);
